...
const favFalse = "assets/images/white_star.png"; //assets\images\white_star.png
...
function renderPage(data) {
  ...
  // Appearance
  document.getElementById("appearance").innerHTML = makePresentable(
    data.appearance
  );
  // Biography
  document.getElementById("biography").innerHTML = makePresentable(
    data.biography
  );
  // Occupation
  document.getElementById("occupation").innerHTML = makePresentable(data.work);
  // Connections
  document.getElementById("connections").innerHTML = makePresentable(
    data.connections
  );
}
